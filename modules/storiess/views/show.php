...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('storiess/manage', 'View All Storiess', array("class" => "button alt"));
        echo anchor('storiess/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                <div class="row">
                    <div>Original Headline</div>
                    <div><?= $original_headline ?></div>
                </div>
                <div class="row">
                    <div class="full-width">
                        <div><b>Funny Headline</b></div>
                        <div><?= nl2br($funny_headline) ?></div>
                    </div>
                </div>
                <div class="row">
                    <div class="full-width">
                        <div><b>Picture</b></div>
                        <div><?= nl2br($picture) ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('storiess/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Stories record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
